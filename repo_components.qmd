...
Core structure, files, directories suggested for a GitHub repository, aka a *Repo* 
...
### 32. **Suggested** 
  ...
  - A *vignettes/* directory for examples, scripts, and demonstration of code in the functions directory .
